...
$$\mu | \vec{y} \; \sim \; N\bigg(\frac{6.5*0.593^2/25 + 5.734*0.4^2}{0.4^2+0.593^2/25}, \; \frac{0.4^2*0.593^2/25}{0.4^2+0.593^2/25}\bigg)\;,$$
...
```{r fig.width=9}
plot_normal_normal(mean = 6.5, sd = 0.4, sigma = 0.593, 
  y_bar = 5.734, n = 25)
```
...
summarize_normal_normal(mean = 6.5, sd = 0.4, sigma = 0.593, 
  y_bar = 5.735, n = 25)
```
