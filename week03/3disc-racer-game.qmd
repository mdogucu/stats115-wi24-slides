...
# {background-image="slides-figures/start_line.jpg" background-position="middle" background-size="contain"}
...
#  {background-image="slides-figures/finish_line.jpg" background-position="middle" background-size="contain"}
